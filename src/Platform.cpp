...
SDL_Window *create_window_or_throw(int window_width, int window_height) {
  SDL_Window *window = SDL_CreateWindow(
      Config::window_title.data(), SDL_WINDOWPOS_CENTERED,
...
SDL_Texture *create_texture_or_throw(SDL_Renderer *renderer, int texture_width,
                                     int texture_height) {
...
Platform::Platform(int window_width, int window_height, int texture_width,
                   int texture_height)
    : m_window{Loader::create_window_or_throw(window_width, window_height),
               SDL_DestroyWindow},
      m_renderer{Loader::create_renderer_or_throw(m_window.get()),
                 SDL_DestroyRenderer},
      m_texture{Loader::create_texture_or_throw(m_renderer.get(), texture_width,
                                                texture_height),
                SDL_DestroyTexture} {
